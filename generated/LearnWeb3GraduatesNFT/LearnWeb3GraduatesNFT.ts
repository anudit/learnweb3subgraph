...
export class LearnWeb3GraduatesNFT extends ethereum.SmartContract {
  static bind(address: Address): LearnWeb3GraduatesNFT {
    return new LearnWeb3GraduatesNFT("LearnWeb3GraduatesNFT", address);
  }
